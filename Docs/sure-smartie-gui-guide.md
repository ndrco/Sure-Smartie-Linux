...
- если текущий вывод уже длиннее, движок принудительно возвращает позицию на указанную колонку,
  а последующий текст перезаписывает «хвост» справа.
...
Дополнительный пример принудительного возврата:
